      ...
      <div className="mb-4 sm:mb-6">
        ...
        <div className="flex items-start sm:items-center gap-3">
          ...
          <div className="min-w-0">
            <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold break-words">{selectedModuleData.fullName}</h1>
            <p className="text-sm sm:text-base text-gray-600 mt-1">{selectedModuleData.description}</p>
          </div>
        </div>
      </div>
      <LectureList 
        lectures={selectedModuleData.lectures} 
